...
public class BulkAddTagsResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BulkAddTagsResponse { SuccessfullyUpdatedFileIds = ["string"] };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BulkAddTagsResponse>(
            json,
    ...
    {
        var model = new BulkAddTagsResponse { };
    ...
    public void CopyConstructor_Works()
    {
        ...
        BulkAddTagsResponse copied = new(model);
