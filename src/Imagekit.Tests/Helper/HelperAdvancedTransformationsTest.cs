...
public class HelperAdvancedTransformationsTest
{
    ...
    public void Gradient_True_GeneratesEGradient()
    {
        var url = _client.Helper.BuildUrl(new SrcOptions
        {
            UrlEndpoint = "https://ik.imagekit.io/test_url_endpoint",
            Src = "/test_path1.jpg",
            Transformation = [new Transformation { Gradient = new TransformationGradientDefault() }],
            TransformationPosition = TransformationPosition.Query,
        });
    ...
    public void AIRemoveBackground_WithWidthAndHeight_IncludesAllTransforms()
    {
        var url = _client.Helper.BuildUrl(new SrcOptions
        {
            ...
            Transformation =
            [
                new Transformation { Width = 300.0, Height = 200.0, AIRemoveBackground = true },
            ],
            TransformationPosition = TransformationPosition.Query,
        });
        ...
        var url = _client.Helper.BuildUrl(new SrcOptions
        {
            ...
            [
                new Transformation
                {
                    ...
                    EndOffset = 15.0,
                    Duration = 10.0,
                    StreamingResolutions = [StreamingResolution.V1440, StreamingResolution.V1080],
                    Grayscale = true,
                    AIUpscale = true,
                    AIRetouch = true,
                    AIVariation = true,
