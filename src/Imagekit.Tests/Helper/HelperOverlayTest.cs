...
public class HelperOverlayTest
{
    ...
    public void SubtitleOverlay_EmptyInput_IgnoresOverlay()
    {
        var url = _client.Helper.BuildUrl(
            new SrcOptions
            {
                ...
                Transformation =
                [
                    new Transformation { Overlay = new SubtitleOverlay { Input = "" } },
                ],
                TransformationPosition = TransformationPosition.Path,
            }
        );
    ...
    public void SolidColorOverlay_EmptyColor_IgnoresOverlay()
    {
        var url = _client.Helper.BuildUrl(
            new SrcOptions
            {
                ...
                Transformation =
                [
                    new Transformation { Overlay = new SolidColorOverlay { Color = "" } },
                ],
                TransformationPosition = TransformationPosition.Path,
            }
        );
    ...
    public void VideoOverlay_PlayPauseLoop_GeneratesLayer()
    {
        var url = _client.Helper.BuildUrl(
            new SrcOptions
            {
                ...
                Transformation =
                [
                    new Transformation { Overlay = new VideoOverlay("play-pause-loop.mp4") },
                ],
                TransformationPosition = TransformationPosition.Path,
            }
        );
    ...
    public void SubtitleOverlay_SubtitleSrt_GeneratesLayer()
    {
        var url = _client.Helper.BuildUrl(
            new SrcOptions
            {
                ...
                Transformation =
                [
                    new Transformation { Overlay = new SubtitleOverlay("subtitle.srt") },
                ],
                TransformationPosition = TransformationPosition.Path,
            }
        );
    ...
    public void ImageOverlay_SlashesInPath_ConvertedToDoubleAt()
    {
        var url = _client.Helper.BuildUrl(
            new SrcOptions
            {
                ...
                Transformation =
                [
                    new Transformation { Overlay = new ImageOverlay("/customer_logo/nykaa.png") },
                ],
                TransformationPosition = TransformationPosition.Path,
            }
        );
    ...
    public void ImageOverlay_SpecialCharsInPath_UsesBase64Encoding()
    {
        var url = _client.Helper.BuildUrl(
            new SrcOptions
            {
                ...
                Transformation =
                [
                    new Transformation { Overlay = new ImageOverlay("/customer_logo/Ñykaa.png") },
                ],
                TransformationPosition = TransformationPosition.Path,
            }
        );
    ...
    public void TextOverlay_UnicodeSpecialChars_UsesBase64()
    {
        var url = _client.Helper.BuildUrl(
            new SrcOptions
            {
                ...
                Transformation =
                [
                    new Transformation { Overlay = new TextOverlay("Let's use ©, ®, ™, etc") },
                ],
                TransformationPosition = TransformationPosition.Path,
            }
        );
    ...
    public void TextOverlay_ExplicitPlainEncoding_UsesPlain()
    {
        ...
        Assert.Equal("https://ik.imagekit.io/demo/tr:l-text,i-HelloWorld,l-end/sample.jpg", url);
    }
    ...
    public void SubtitleOverlay_ExplicitPlainEncoding_NormalizesSlashes()
    {
        ...
        Assert.Equal("https://ik.imagekit.io/demo/tr:l-subtitles,i-sub.srt,l-end/sample.mp4", url);
    }
        ...
        var url = _client.Helper.BuildUrl(
            new SrcOptions
            {
                ...
                [
                    new Transformation
                    {
                        Overlay = new ImageOverlay("displacement.png")
                        {
                            LayerMode = LayerMode.Displace,
                        },
                    },
                ],
                TransformationPosition = TransformationPosition.Path,
