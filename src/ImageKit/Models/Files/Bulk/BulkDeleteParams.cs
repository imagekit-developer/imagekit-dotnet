...
/// </summary>
public record class BulkDeleteParams : ParamsBase
{
    ...
    public BulkDeleteParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public BulkDeleteParams(BulkDeleteParams bulkDeleteParams)
        : base(bulkDeleteParams)
    {
        this._rawBodyData = new(bulkDeleteParams._rawBodyData);
    }
...
#pragma warning restore CS8618
    ...
    public static BulkDeleteParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        IReadOnlyDictionary<string, JsonElement> rawBodyData
    )
    ...
    public virtual bool Equals(BulkDeleteParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    public override Uri Url(ClientOptions options)
    {
        return new UriBuilder(
            options.BaseUrl.ToString().TrimEnd('/') + "/v1/files/batch/deleteByFileIds"
        )
        {
