...
/// </summary>
public record class BulkRemoveAITagsParams : ParamsBase
{
    ...
    public BulkRemoveAITagsParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public BulkRemoveAITagsParams(BulkRemoveAITagsParams bulkRemoveAITagsParams)
        : base(bulkRemoveAITagsParams)
    {
        this._rawBodyData = new(bulkRemoveAITagsParams._rawBodyData);
    }
...
#pragma warning restore CS8618
    ...
    public static BulkRemoveAITagsParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        IReadOnlyDictionary<string, JsonElement> rawBodyData
    )
    ...
    public virtual bool Equals(BulkRemoveAITagsParams? other)
    {
        if (other == null)
        {
            return false;
