...
/// </summary>
public record class FileMoveParams : ParamsBase
{
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    public FileMoveParams(FileMoveParams fileMoveParams)
        : base(fileMoveParams)
    {
        this._rawBodyData = new(fileMoveParams._rawBodyData);
    }
...
#pragma warning restore CS8618
    ...
    public static FileMoveParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        IReadOnlyDictionary<string, JsonElement> rawBodyData
    )
    ...
    public virtual bool Equals(FileMoveParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    {
        return new UriBuilder(options.BaseUrl.ToString().TrimEnd('/') + "/v1/files/move")
        {
