...
namespace Imagekit.Models.UnnamedSchemaWithArrayParent0Properties.AIAutoDescriptionProperties;
...
public class Name
{
    ...
    public Name()
    {
        Json = JsonSerializer.Deserialize<JsonElement>("\"ai-auto-description\"");
    }
