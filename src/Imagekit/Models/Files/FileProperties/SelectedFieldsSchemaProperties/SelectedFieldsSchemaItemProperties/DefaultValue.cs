...
public record class DefaultValue
{
    ...
    public DefaultValue(List<UnnamedSchemaWithArrayParent4> value)
    {
        Value = value;
    }
    ...
    public bool TryPickMixed([NotNullWhen(true)] out List<UnnamedSchemaWithArrayParent4>? value)
    {
        value = this.Value as List<UnnamedSchemaWithArrayParent4>;
        return value != null;
    }
    ...
    public void Switch(
        ...
        System::Action<List<UnnamedSchemaWithArrayParent4>> mixed
    )
    {
        switch (this.Value)
        {
            ...
            case bool value:
                @bool(value);
                break;
            case List<UnnamedSchemaWithArrayParent4> value:
                mixed(value);
                break;
            default:
    ...
    public T Match<T>(
        ...
        System::Func<List<UnnamedSchemaWithArrayParent4>, T> mixed
    )
    {
        return this.Value switch
        {
            ...
            List<UnnamedSchemaWithArrayParent4> value => mixed(value),
        ...
        catch (System::Exception e) when (e is JsonException || e is ImageKitInvalidDataException)
        {
            exceptions.Add(
                new ImageKitInvalidDataException(
                    "Data does not match union variant 'List<UnnamedSchemaWithArrayParent4>'",
                    e
                )
            );
        }
