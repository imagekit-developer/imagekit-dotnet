...
using Imagekit.Models.Files.FileUploadResponseProperties.SelectedFieldsSchemaProperties.SelectedFieldsSchemaItemProperties.DefaultValueProperties.UnnamedSchemaWithArrayParent5Variants;
using System = System;

namespace Imagekit.Models.Files.FileUploadResponseProperties.SelectedFieldsSchemaProperties.SelectedFieldsSchemaItemProperties.DefaultValueProperties;

[JsonConverter(typeof(UnnamedSchemaWithArrayParent5Converter))]
public abstract record class UnnamedSchemaWithArrayParent5
{
    internal UnnamedSchemaWithArrayParent5() { }

    public static implicit operator UnnamedSchemaWithArrayParent5(string value) =>
        new String(value);

    public static implicit operator UnnamedSchemaWithArrayParent5(double value) =>
        new Double(value);

    public static implicit operator UnnamedSchemaWithArrayParent5(bool value) => new Bool(value);
