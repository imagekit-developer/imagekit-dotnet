...
public record class UnnamedSchemaWithArrayParent5
{
    public object Value { get; private init; }

    public UnnamedSchemaWithArrayParent5(string value)
    {
        Value = value;
    }

    public UnnamedSchemaWithArrayParent5(double value)
    {
        Value = value;
    }

    public UnnamedSchemaWithArrayParent5(bool value)
    {
        Value = value;
    }

    UnnamedSchemaWithArrayParent5(UnknownVariant value)
    {
        Value = value;
    }

    public static UnnamedSchemaWithArrayParent5 CreateUnknownVariant(JsonElement value)
    {
...
sealed class UnnamedSchemaWithArrayParent5Converter : JsonConverter<UnnamedSchemaWithArrayParent5>
{
    ...
    )
    {
        ...
        try
        {
            ...
            {
                return new UnnamedSchemaWithArrayParent5(deserialized);
            }
        }
        ...
        try
        {
            return new UnnamedSchemaWithArrayParent5(
