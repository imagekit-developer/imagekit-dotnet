...
public record class DefaultValue
{
    ...
    public DefaultValue(List<UnnamedSchemaWithArrayParent5> value)
    {
        Value = value;
    }
    ...
    {
        value = this.Value as List<UnnamedSchemaWithArrayParent5>;
        return value != null;
    }
    ...
    public void Switch(
        ...
        System::Action<List<UnnamedSchemaWithArrayParent5>> mixed
    )
    {
        switch (this.Value)
        {
            ...
            case bool value:
                @bool(value);
                break;
            case List<UnnamedSchemaWithArrayParent5> value:
                mixed(value);
                break;
            default:
    ...
    public T Match<T>(
        ...
        System::Func<List<UnnamedSchemaWithArrayParent5>, T> mixed
    )
    {
        return this.Value switch
        {
            ...
            List<UnnamedSchemaWithArrayParent5> value => mixed(value),
        ...
        catch (System::Exception e) when (e is JsonException || e is ImageKitInvalidDataException)
        {
            exceptions.Add(
                new ImageKitInvalidDataException(
                    "Data does not match union variant 'List<UnnamedSchemaWithArrayParent5>'",
                    e
                )
            );
        }
