...
[JsonConverter(typeof(ModelConverter<FileUploadV1ByURL>))]
public sealed record class FileUploadV1ByURL : ModelBase, IFromRaw<FileUploadV1ByURL>
{
    /// <summary>
    /// A publicly reachable URL that ImageKit’s servers can fetch. The server must
    /// receive the response headers within 8 seconds; otherwise the request fails
    ...
    /// </summary>
    public List<FileUploadV1ByURLProperties::Extension>? Extensions
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<List<FileUploadV1ByURLProperties::Extension>?>(
                element,
                ModelBase.SerializerOptions
            );
        }
    ...
    /// </summary>
    public List<ApiEnum<string, FileUploadV1ByURLProperties::ResponseField>>? ResponseFields
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<List<
                ApiEnum<string, FileUploadV1ByURLProperties::ResponseField>
    ...
    /// </summary>
    public FileUploadV1ByURLProperties::Transformation? Transformation
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<FileUploadV1ByURLProperties::Transformation?>(
                element,
                ModelBase.SerializerOptions
            );
        }
    ...
    public FileUploadV1ByURL() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    FileUploadV1ByURL(Dictionary<string, JsonElement> properties)
    {
        Properties = properties;
    }
#pragma warning restore CS8618

    public static FileUploadV1ByURL FromRawUnchecked(Dictionary<string, JsonElement> properties)
    {
