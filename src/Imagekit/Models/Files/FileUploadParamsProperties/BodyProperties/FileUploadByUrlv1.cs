...
using FileUploadByUrlv1Properties = Imagekit.Models.Files.FileUploadParamsProperties.BodyProperties.FileUploadByUrlv1Properties;

namespace Imagekit.Models.Files.FileUploadParamsProperties.BodyProperties;

[JsonConverter(typeof(ModelConverter<FileUploadByUrlv1>))]
public sealed record class FileUploadByUrlv1 : ModelBase, IFromRaw<FileUploadByUrlv1>
{
    /// <summary>
    ...
    /// </summary>
    public List<FileUploadByUrlv1Properties::Extension>? Extensions
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<List<FileUploadByUrlv1Properties::Extension>?>(
                element,
                ModelBase.SerializerOptions
            );
        }
    ...
    /// </summary>
    public List<ApiEnum<string, FileUploadByUrlv1Properties::ResponseField>>? ResponseFields
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<List<
                ApiEnum<string, FileUploadByUrlv1Properties::ResponseField>
    ...
    /// </summary>
    public FileUploadByUrlv1Properties::Transformation? Transformation
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<FileUploadByUrlv1Properties::Transformation?>(
                element,
                ModelBase.SerializerOptions
            );
        }
    ...
    public FileUploadByUrlv1() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    FileUploadByUrlv1(Dictionary<string, JsonElement> properties)
    {
        Properties = properties;
    }
#pragma warning restore CS8618

    public static FileUploadByUrlv1 FromRawUnchecked(Dictionary<string, JsonElement> properties)
    {
