...
using ExtensionProperties = Imagekit.Models.Files.FileUploadParamsProperties.ExtensionProperties;

namespace Imagekit.Models.Files.FileUploadParamsProperties.ExtensionVariants;
