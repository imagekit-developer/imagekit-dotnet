...
using RadiusVariants = Imagekit.Models.SolidColorOverlayTransformationProperties.RadiusVariants;

namespace Imagekit.Models.SolidColorOverlayTransformationProperties;

/// <summary>
/// Specifies the corner radius of the solid color overlay. Set to `max` for circular
