...
namespace Imagekit.Models.Beta.V2.Files.FileUploadParamsProperties.TransformationProperties.PostProperties.TransformationProperties;
...
public class Type
{
    ...
    public Type()
    {
        Json = JsonSerializer.Deserialize<JsonElement>("\"transformation\"");
    }
