...
/// </summary>
public record class FolderMoveParams : ParamsBase
{
    ...
    public FolderMoveParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public FolderMoveParams(FolderMoveParams folderMoveParams)
        : base(folderMoveParams)
    {
        this._rawBodyData = new(folderMoveParams._rawBodyData);
    }
...
#pragma warning restore CS8618
    ...
    public static FolderMoveParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        IReadOnlyDictionary<string, JsonElement> rawBodyData
    )
    ...
    public virtual bool Equals(FolderMoveParams? other)
    {
        if (other == null)
        {
            return false;
