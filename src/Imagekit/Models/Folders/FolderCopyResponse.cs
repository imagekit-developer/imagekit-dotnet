...
/// </summary>
[JsonConverter(typeof(ModelConverter<FolderCopyResponse>))]
public sealed record class FolderCopyResponse : ModelBase, IFromRaw<FolderCopyResponse>
{
    /// <summary>
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    FolderCopyResponse(Dictionary<string, JsonElement> properties)
    {
        Properties = properties;
    }
#pragma warning restore CS8618

    public static FolderCopyResponse FromRawUnchecked(Dictionary<string, JsonElement> properties)
    {
