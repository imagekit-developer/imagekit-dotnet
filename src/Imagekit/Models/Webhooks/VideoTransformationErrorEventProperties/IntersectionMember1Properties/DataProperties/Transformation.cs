...
using TransformationProperties = Imagekit.Models.Webhooks.VideoTransformationErrorEventProperties.DataProperties.TransformationProperties;

namespace Imagekit.Models.Webhooks.VideoTransformationErrorEventProperties.DataProperties;

[JsonConverter(
    typeof(ModelConverter<global::Imagekit.Models.Webhooks.VideoTransformationErrorEventProperties.IntersectionMember1Properties.DataProperties.Transformation>)
)]
public sealed record class Transformation
    : ModelBase,
        IFromRaw<global::Imagekit.Models.Webhooks.VideoTransformationErrorEventProperties.IntersectionMember1Properties.DataProperties.Transformation>
{
    /// <summary>
    ...
    /// </summary>
    public TransformationProperties::Error? Error
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<TransformationProperties::Error?>(
                element,
                ModelBase.SerializerOptions
            );
        }
...
#pragma warning restore CS8618
    ...
    public static global::Imagekit.Models.Webhooks.VideoTransformationErrorEventProperties.IntersectionMember1Properties.DataProperties.Transformation FromRawUnchecked(
