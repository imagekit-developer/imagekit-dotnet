...
using Imagekit.Models.Webhooks.UploadPostTransformSuccessEventProperties;
...
/// </summary>
[JsonConverter(typeof(ModelConverter<UploadPostTransformSuccessEvent>))]
public sealed record class UploadPostTransformSuccessEvent
    : ModelBase,
        IFromRaw<UploadPostTransformSuccessEvent>
{
    /// <summary>
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    UploadPostTransformSuccessEvent(Dictionary<string, JsonElement> properties)
    {
