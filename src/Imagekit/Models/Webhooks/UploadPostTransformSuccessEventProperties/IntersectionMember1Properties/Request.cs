...
using RequestProperties = Imagekit.Models.Webhooks.UploadPostTransformSuccessEventProperties.RequestProperties;
...
{
    public required RequestProperties::Transformation Transformation
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<RequestProperties::Transformation>(
                    element,
