...
using Imagekit.Models.Webhooks.UploadPreTransformSuccessEventProperties.IntersectionMember1Properties.DataProperties.SelectedFieldsSchemaProperties.SelectedFieldsSchemaItemProperties.DefaultValueVariants;
using System = System;
...
public abstract record class DefaultValue
{
    ...
    public static implicit operator DefaultValue(List<UnnamedSchemaWithArrayParent7> value) =>
        new Mixed(value);
