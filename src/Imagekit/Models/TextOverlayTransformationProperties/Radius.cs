...
using RadiusVariants = Imagekit.Models.TextOverlayTransformationProperties.RadiusVariants;

namespace Imagekit.Models.TextOverlayTransformationProperties;

/// <summary>
/// Specifies the corner radius of the text overlay. Set to `max` to achieve a circular
/// or oval shape.
/// </summary>
