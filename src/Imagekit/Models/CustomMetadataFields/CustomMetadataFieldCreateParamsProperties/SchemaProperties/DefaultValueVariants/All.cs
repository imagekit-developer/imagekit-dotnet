...
namespace Imagekit.Models.CustomMetadataFields.CustomMetadataFieldCreateParamsProperties.SchemaProperties.DefaultValueVariants;
...
/// `MultiSelect`.
/// </summary>
public sealed record class Mixed(List<UnnamedSchemaWithArrayParent1> Value)
    : DefaultValue,
        IVariant<Mixed, List<UnnamedSchemaWithArrayParent1>>
{
    public static Mixed From(List<UnnamedSchemaWithArrayParent1> value)
    {
        return new(value);
    }
