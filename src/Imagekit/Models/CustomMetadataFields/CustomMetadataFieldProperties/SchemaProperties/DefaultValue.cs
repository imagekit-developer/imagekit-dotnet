...
using Imagekit.Models.CustomMetadataFields.CustomMetadataFieldProperties.SchemaProperties.DefaultValueProperties;
using System = System;
...
public record class DefaultValue
{
    ...
    public DefaultValue(List<UnnamedSchemaWithArrayParent1> value)
    {
        Value = value;
    }
    ...
    {
        value = this.Value as List<UnnamedSchemaWithArrayParent1>;
        return value != null;
    }
    ...
    public void Switch(
        ...
        System::Action<List<UnnamedSchemaWithArrayParent1>> mixed
    )
    {
        switch (this.Value)
        {
            ...
            case bool value:
                @bool(value);
                break;
            case List<UnnamedSchemaWithArrayParent1> value:
                mixed(value);
                break;
            default:
    ...
    public T Match<T>(
        ...
        System::Func<List<UnnamedSchemaWithArrayParent1>, T> mixed
    )
    {
        return this.Value switch
        {
            ...
            List<UnnamedSchemaWithArrayParent1> value => mixed(value),
        ...
        catch (System::Exception e) when (e is JsonException || e is ImageKitInvalidDataException)
        {
            exceptions.Add(
                new ImageKitInvalidDataException(
                    "Data does not match union variant 'List<UnnamedSchemaWithArrayParent1>'",
                    e
                )
            );
        }
