...
public sealed record class Transformation : JsonModel
{
    ...
    /// <summary>
    /// Sets the output image density in dots per inch (DPI). Accepts an integer from
    /// 1 to 1200 or an arithmetic expression using the `idn` variable, such as `idn_mul_2`.
    /// For raster images, this updates density metadata without changing dimensions.
    /// For vector images, it controls the DPI used during rasterization. Cannot be
    /// used inside layers. See [Density](https://imagekit.io/docs/image-optimization#density---dn).
    /// </summary>
    public Density? Density
    {
        ...
        {
            this._rawData.Freeze();
            return this._rawData.GetNullableClass<Density>("density");
        }
        init
        {
            if (value == null)
...
public record class AIDropShadow : ModelBase
{
    ...
    /// </example>
    /// </summary>
    public void Switch(System::Action<AIDropShadowDefault> default_, System::Action<string> @string)
    {
        switch (this.Value)
        {
    ...
    /// </summary>
    public T Match<T>(
        System::Func<AIDropShadowDefault, T> default_,
...
/// 1 to 1200 or an arithmetic expression using the `idn` variable, such as `idn_mul_2`.
/// For raster images, this updates density metadata without changing dimensions.
/// For vector images, it controls the DPI used during rasterization. Cannot be used
/// inside layers. See [Density](https://imagekit.io/docs/image-optimization#density---dn).
/// </summary>
[JsonConverter(typeof(DensityConverter))]
public record class Density : ModelBase
{
    public object? Value { get; } = null;
    ...
    public Density(long value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public Density(string value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public Density(JsonElement element)
    {
        this._element = element;
    }
    ...
    public void Switch(System::Action<long> @long, System::Action<string> @string)
    {
        switch (this.Value)
        {
            ...
            case string value:
                ...
                break;
            default:
                throw new ImageKitInvalidDataException("Data did not match any variant of Density");
        }
    }
    ...
    public T Match<T>(System::Func<long, T> @long, System::Func<string, T> @string)
    {
        return this.Value switch
        {
            ...
            string value => @string(value),
            _ => throw new ImageKitInvalidDataException(
                "Data did not match any variant of Density"
            ),
        };
    }

    public static implicit operator Density(long value) => new(value);

    public static implicit operator Density(string value) => new(value);
    ...
    public virtual bool Equals(Density? other) =>
        other != null
        && this.VariantIndex() == other.VariantIndex()
        && JsonElement.DeepEquals(this.Json, other.Json);
...
sealed class DensityConverter : JsonConverter<Density>
{
    public override Density? Read(
        ref Utf8JsonReader reader,
        System::Type typeToConvert,
        JsonSerializerOptions options
    )
...
public record class TransformationGradient : ModelBase
{
    ...
    /// </summary>
    public void Switch(
        System::Action<TransformationGradientDefault> default_,
    ...
    /// </summary>
    public T Match<T>(
        System::Func<TransformationGradientDefault, T> default_,
        System::Func<string, T> @string
    )
    {
        return this.Value switch
...
public record class TransformationRadius : ModelBase
{
    ...
    public void Switch(
        ...
        System::Action<TransformationRadiusMax> max,
        System::Action<string> @string
    )
    {
        switch (this.Value)
    ...
    public T Match<T>(
        ...
        System::Func<TransformationRadiusMax, T> max,
        System::Func<string, T> @string
    )
    {
        return this.Value switch
...
public record class Shadow : ModelBase
{
    ...
    /// </example>
    /// </summary>
    public void Switch(System::Action<ShadowDefault> default_, System::Action<string> @string)
    {
        switch (this.Value)
        {
    ...
    /// </example>
    /// </summary>
    public T Match<T>(System::Func<ShadowDefault, T> default_, System::Func<string, T> @string)
    {
        return this.Value switch
        {
...
public record class Sharpen : ModelBase
{
    ...
    /// </example>
    /// </summary>
    public void Switch(System::Action<SharpenDefault> default_, System::Action<double> @double)
    {
        switch (this.Value)
        {
    ...
    /// </example>
    /// </summary>
    public T Match<T>(System::Func<SharpenDefault, T> default_, System::Func<double, T> @double)
    {
        return this.Value switch
        {
...
public record class Trim : ModelBase
{
    ...
    /// </example>
    /// </summary>
    public void Switch(System::Action<TrimDefault> default_, System::Action<double> @double)
    {
        switch (this.Value)
        {
    ...
    /// </example>
    /// </summary>
    public T Match<T>(System::Func<TrimDefault, T> default_, System::Func<double, T> @double)
    {
        return this.Value switch
        {
...
public record class UnsharpMask : ModelBase
{
    ...
    /// </example>
    /// </summary>
    public void Switch(System::Action<UnsharpMaskDefault> default_, System::Action<string> @string)
    {
        switch (this.Value)
        {
    ...
    /// </example>
    /// </summary>
    public T Match<T>(System::Func<UnsharpMaskDefault, T> default_, System::Func<string, T> @string)
    {
        return this.Value switch
        {
