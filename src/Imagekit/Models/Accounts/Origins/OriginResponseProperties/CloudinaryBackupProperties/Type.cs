...
namespace Imagekit.Models.Accounts.Origins.OriginResponseProperties.CloudinaryBackupProperties;
...
public class Type
{
    ...
    public Type()
    {
        Json = JsonSerializer.Deserialize<JsonElement>("\"CLOUDINARY_BACKUP\"");
    }
