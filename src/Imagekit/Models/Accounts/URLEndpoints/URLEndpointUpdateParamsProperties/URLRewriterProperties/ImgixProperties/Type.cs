...
namespace Imagekit.Models.Accounts.URLEndpoints.URLEndpointUpdateParamsProperties.URLRewriterProperties.ImgixProperties;
...
public class Type
{
    ...
    public Type()
    {
        Json = JsonSerializer.Deserialize<JsonElement>("\"IMGIX\"");
    }
