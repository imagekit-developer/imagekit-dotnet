...
using URLRewriterProperties = Imagekit.Models.Accounts.URLEndpoints.URLEndpointUpdateParamsProperties.URLRewriterProperties;

namespace Imagekit.Models.Accounts.URLEndpoints.URLEndpointUpdateParamsProperties.URLRewriterVariants;
