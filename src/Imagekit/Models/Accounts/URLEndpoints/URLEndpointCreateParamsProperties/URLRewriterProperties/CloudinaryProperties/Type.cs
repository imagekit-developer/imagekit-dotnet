...
namespace Imagekit.Models.Accounts.URLEndpoints.URLEndpointCreateParamsProperties.URLRewriterProperties.CloudinaryProperties;
...
public class Type
{
    ...
    public Type()
    {
        Json = JsonSerializer.Deserialize<JsonElement>("\"CLOUDINARY\"");
    }
