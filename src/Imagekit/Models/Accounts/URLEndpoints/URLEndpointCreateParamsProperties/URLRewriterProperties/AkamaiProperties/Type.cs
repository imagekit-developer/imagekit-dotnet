...
namespace Imagekit.Models.Accounts.URLEndpoints.URLEndpointCreateParamsProperties.URLRewriterProperties.AkamaiProperties;
...
public class Type
{
    ...
    public Type()
    {
        Json = JsonSerializer.Deserialize<JsonElement>("\"AKAMAI\"");
    }
