...
using URLRewriterProperties = Imagekit.Models.Accounts.URLEndpoints.URLEndpointRequestProperties.URLRewriterProperties;

namespace Imagekit.Models.Accounts.URLEndpoints.URLEndpointRequestProperties.URLRewriterVariants;
