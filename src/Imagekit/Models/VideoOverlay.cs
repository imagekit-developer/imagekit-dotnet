...
using Imagekit.Models.VideoOverlayProperties.IntersectionMember1Properties;

namespace Imagekit.Models;

[JsonConverter(typeof(ModelConverter<VideoOverlay>))]
public sealed record class VideoOverlay : ModelBase, IFromRaw<VideoOverlay>
{
    ...
    public static implicit operator BaseOverlay(VideoOverlay videoOverlay) =>
        new() { Position = videoOverlay.Position, Timing = videoOverlay.Timing };
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    VideoOverlay(Dictionary<string, JsonElement> properties)
    {
        Properties = properties;
    }
#pragma warning restore CS8618

    public static VideoOverlay FromRawUnchecked(Dictionary<string, JsonElement> properties)
    {
