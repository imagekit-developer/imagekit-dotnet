...
public sealed record class Transformation : JsonModel
{
    ...
    /// `4_3`, or an expression like `iar_div_2`. See [Image resize and crop – Aspect ratio](https://imagekit.io/docs/image-resize-and-crop#aspect-ratio---ar).
    /// </summary>
    ...
    /// be hex codes (e.g., `FF0022`) or names (e.g., `red`, `blue`). See [Color replacement](https://imagekit.io/docs/effects-and-enhancements#color-replace---cr).
    /// </summary>
    ...
    /// <summary>
    /// Automatically enhances the contrast of an image (contrast stretch). See [Contrast Stretch](https://imagekit.io/docs/effects-and-enhancements#contrast-stretch---e-contrast).
    /// </summary>
    ...
    /// `10.5`.  Arithmetic expressions are also supported. See [Trim videos – Start offset](https://imagekit.io/docs/trim-videos#start-offset---so).
    /// </summary>
    ...
    /// </summary>
    public IReadOnlyList<ApiEnum<string, TransformationStreamingResolution>>? StreamingResolutions
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNullableStruct<
                ImmutableArray<ApiEnum<string, TransformationStreamingResolution>>
        ...
        init
        {
            ...
            this._rawData.Set<ImmutableArray<ApiEnum<string, TransformationStreamingResolution>>?>(
                "streamingResolutions",
...
public record class AIDropShadowDefault
{
    ...
    public void Validate()
    {
        ...
        {
            throw new ImagekitDiversionInvalidDataException(
                "Invalid value given for 'AIDropShadowDefault'"
            );
        }
    }
...
/// 2nd and 3rd layers), or by name (e.g., `name-layer-4` for a PSD layer). See [Thumbnail extraction](https://imagekit.io/docs/vector-and-animated-images#get-thumbnail-from-psd-pdf-ai-eps-and-animated-files).
/// </summary>
...
public record class Page : ModelBase
{
    ...
    public void Switch(Action<double> @double, Action<string> @string)
    {
        switch (this.Value)
        {
            ...
            default:
                throw new ImagekitDiversionInvalidDataException(
                    "Data did not match any variant of Page"
                );
        }
    }
...
public record class Shadow : ModelBase
{
    ...
    public void Switch(Action<ShadowDefault> default_, Action<string> @string)
    {
        switch (this.Value)
        {
            ...
            default:
                throw new ImagekitDiversionInvalidDataException(
                    "Data did not match any variant of Shadow"
                );
        }
    }
...
public record class ShadowDefault
{
    ...
    public void Validate()
    {
        ...
        {
            throw new ImagekitDiversionInvalidDataException(
                "Invalid value given for 'ShadowDefault'"
            );
        }
    }
...
public record class SharpenDefault
{
    ...
    public void Validate()
    {
        ...
        {
            throw new ImagekitDiversionInvalidDataException(
                "Invalid value given for 'SharpenDefault'"
            );
        }
    }
...
/// </summary>
[JsonConverter(typeof(TransformationStreamingResolutionConverter))]
public enum TransformationStreamingResolution
{
    V240,
    V360,
    V480,
...
sealed class TransformationStreamingResolutionConverter
    : JsonConverter<TransformationStreamingResolution>
{
    public override TransformationStreamingResolution Read(
        ref Utf8JsonReader reader,
        Type typeToConvert,
        JsonSerializerOptions options
    )
    {
        return JsonSerializer.Deserialize<string>(ref reader, options) switch
        {
            "240" => TransformationStreamingResolution.V240,
            "360" => TransformationStreamingResolution.V360,
            "480" => TransformationStreamingResolution.V480,
            "720" => TransformationStreamingResolution.V720,
            "1080" => TransformationStreamingResolution.V1080,
            "1440" => TransformationStreamingResolution.V1440,
            "2160" => TransformationStreamingResolution.V2160,
            _ => (TransformationStreamingResolution)(-1),
        };
    }

    public override void Write(
        Utf8JsonWriter writer,
        TransformationStreamingResolution value,
        JsonSerializerOptions options
    )
    {
        JsonSerializer.Serialize(
            ...
            value switch
            {
                TransformationStreamingResolution.V240 => "240",
                TransformationStreamingResolution.V360 => "360",
                TransformationStreamingResolution.V480 => "480",
                TransformationStreamingResolution.V720 => "720",
                TransformationStreamingResolution.V1080 => "1080",
                TransformationStreamingResolution.V1440 => "1440",
                TransformationStreamingResolution.V2160 => "2160",
                _ => throw new ImagekitDiversionInvalidDataException(
                    string.Format("Invalid value '{0}' in {1}", value, nameof(value))
                ),
            },
...
public record class Trim : ModelBase
{
    ...
    public void Switch(Action<TrimDefault> default_, Action<double> @double)
    {
        switch (this.Value)
        {
            ...
            default:
                throw new ImagekitDiversionInvalidDataException(
                    "Data did not match any variant of Trim"
                );
        }
    }
...
public record class TrimDefault
{
    ...
    public void Validate()
    {
        ...
        {
            throw new ImagekitDiversionInvalidDataException(
                "Invalid value given for 'TrimDefault'"
            );
        }
    }
...
/// a default unsharp mask, or provide a string for a custom unsharp mask. See [Unsharp Mask](https://imagekit.io/docs/effects-and-enhancements#unsharp-mask---e-usm).
/// </summary>
...
public record class UnsharpMaskDefault
{
    ...
    public void Validate()
    {
        ...
        {
            throw new ImagekitDiversionInvalidDataException(
                "Invalid value given for 'UnsharpMaskDefault'"
            );
        }
    }
