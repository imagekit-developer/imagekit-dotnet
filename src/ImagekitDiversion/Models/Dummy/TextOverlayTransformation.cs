...
public sealed record class TextOverlayTransformation : JsonModel
{
    ...
    /// for clockwise rotation or a string prefixed with "N" for counter-clockwise rotation.
    /// </summary>
...
/// <summary>
/// Flip/mirror the text horizontally, vertically, or in both directions. Acceptable
/// values: `h` (horizontal), `v` (vertical), `h_v` (horizontal and vertical), or `v_h`.
/// </summary>
...
/// array: Provide four underscore-separated values representing top-left, top-right,
/// bottom-right, and bottom-left corners respectively (e.g., `10_20_30_40`). See [Radius](https://imagekit.io/docs/effects-and-enhancements#radius---r).
/// </summary>
