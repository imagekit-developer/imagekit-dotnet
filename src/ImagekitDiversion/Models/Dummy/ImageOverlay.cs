...
public sealed record class ImageOverlay : JsonModel
{
    ...
    /// plain text.</para>
    /// </summary>
    public ApiEnum<string, ImageOverlayImageOverlayEncoding>? Encoding
    {
        get
        {
            this._rawData.Freeze();
...
/// </summary>
[JsonConverter(typeof(ImageOverlayImageOverlayEncodingConverter))]
public enum ImageOverlayImageOverlayEncoding
{
    Auto,
    Plain,
    Base64,
...
sealed class ImageOverlayImageOverlayEncodingConverter
    : JsonConverter<ImageOverlayImageOverlayEncoding>
{
    public override ImageOverlayImageOverlayEncoding Read(
    ...
    )
    {
        ...
        {
            "auto" => ImageOverlayImageOverlayEncoding.Auto,
            "plain" => ImageOverlayImageOverlayEncoding.Plain,
            "base64" => ImageOverlayImageOverlayEncoding.Base64,
            _ => (ImageOverlayImageOverlayEncoding)(-1),
        };
    }

    public override void Write(
        Utf8JsonWriter writer,
        ImageOverlayImageOverlayEncoding value,
        JsonSerializerOptions options
    )
    {
        JsonSerializer.Serialize(
            ...
            value switch
            {
                ImageOverlayImageOverlayEncoding.Auto => "auto",
                ImageOverlayImageOverlayEncoding.Plain => "plain",
                ImageOverlayImageOverlayEncoding.Base64 => "base64",
