...
/// such as `bw_mul_0.4` or `bw_sub_cw`. Maps to `lx` in the URL. Learn about [Arithmetic expressions](https://imagekit.io/docs/arithmetic-expressions-in-transformations).
/// </summary>
...
public record class X : ModelBase
{
        ...
        switch (this.Value)
        {
            ...
            default:
                throw new ImagekitDiversionInvalidDataException(
                    "Data did not match any variant of X"
                );
        }
    }
    ...
    public override void Validate()
    {
        if (this.Value == null)
        {
            throw new ImagekitDiversionInvalidDataException("Data did not match any variant of X");
        }
    }
...
/// overlay's top-left corner will be positioned. It also accepts arithmetic expressions
/// such as `bh_mul_0.4` or `bh_sub_ch`. Maps to `ly` in the URL. Learn about [Arithmetic expressions](https://imagekit.io/docs/arithmetic-expressions-in-transformations).
/// </summary>
...
public record class Y : ModelBase
{
    ...
    public void Switch(Action<double> @double, Action<string> @string)
    {
        switch (this.Value)
        {
            ...
            default:
                throw new ImagekitDiversionInvalidDataException(
                    "Data did not match any variant of Y"
                );
        }
    }
    ...
    public override void Validate()
    {
        if (this.Value == null)
        {
            throw new ImagekitDiversionInvalidDataException("Data did not match any variant of Y");
        }
    }
