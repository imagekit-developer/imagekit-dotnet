...
public record class Default
{
    ...
    public void Validate()
    {
        if (this != new Default())
        {
            throw new ImagekitDiversionInvalidDataException("Invalid value given for 'Default'");
        }
    }
...
public record class Height : ModelBase
{
    ...
    public void Switch(Action<double> @double, Action<string> @string)
    {
        switch (this.Value)
        {
            ...
            default:
                throw new ImagekitDiversionInvalidDataException(
                    "Data did not match any variant of Height"
                );
        }
    }
...
public record class Radius : ModelBase
{
    ...
    public void Switch(Action<double> @double, Action<Max> max, Action<string> @string)
    {
        switch (this.Value)
        {
            ...
            default:
                throw new ImagekitDiversionInvalidDataException(
                    "Data did not match any variant of Radius"
                );
        }
    }
...
public record class Max
{
    ...
    public void Validate()
    {
        if (this != new Max())
        {
            throw new ImagekitDiversionInvalidDataException("Invalid value given for 'Max'");
        }
    }
...
/// arithmetic expression (e.g., `bw_mul_0.2` or `bh_div_2`). Learn about [arithmetic expressions](https://imagekit.io/docs/arithmetic-expressions-in-transformations).
/// </summary>
...
public record class Width : ModelBase
{
    ...
    public void Switch(Action<double> @double, Action<string> @string)
    {
        switch (this.Value)
        {
            ...
            default:
                throw new ImagekitDiversionInvalidDataException(
                    "Data did not match any variant of Width"
                );
        }
    }
