...
public record class FileListParams : ParamsBase
{
    ...
    /// </summary>
    public ApiEnum<string, global::ImagekitDiversion.Models.Files.Type>? Type
    {
        get
        {
            this._rawQueryData.Freeze();
            return this._rawQueryData.GetNullableClass<
                ApiEnum<string, global::ImagekitDiversion.Models.Files.Type>
            >("type");
        }
        init
        {
...
sealed class TypeConverter : JsonConverter<global::ImagekitDiversion.Models.Files.Type>
{
    public override global::ImagekitDiversion.Models.Files.Type Read(
        ref Utf8JsonReader reader,
        System::Type typeToConvert,
        JsonSerializerOptions options
    )
    {
        return JsonSerializer.Deserialize<string>(ref reader, options) switch
        {
            "file" => global::ImagekitDiversion.Models.Files.Type.File,
            "file-version" => global::ImagekitDiversion.Models.Files.Type.FileVersion,
            "folder" => global::ImagekitDiversion.Models.Files.Type.Folder,
            "all" => global::ImagekitDiversion.Models.Files.Type.All,
            _ => (global::ImagekitDiversion.Models.Files.Type)(-1),
        };
    }

    public override void Write(
        Utf8JsonWriter writer,
        global::ImagekitDiversion.Models.Files.Type value,
        JsonSerializerOptions options
    )
    {
        JsonSerializer.Serialize(
            ...
            value switch
            {
                global::ImagekitDiversion.Models.Files.Type.File => "file",
                global::ImagekitDiversion.Models.Files.Type.FileVersion => "file-version",
                global::ImagekitDiversion.Models.Files.Type.Folder => "folder",
                global::ImagekitDiversion.Models.Files.Type.All => "all",
                _ => throw new ImagekitDiversionInvalidDataException(
                    string.Format("Invalid value '{0}' in {1}", value, nameof(value))
                ),
            },
