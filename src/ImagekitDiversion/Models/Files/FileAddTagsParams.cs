...
/// </summary>
public record class FileAddTagsParams : ParamsBase
{
    ...
    public FileAddTagsParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public FileAddTagsParams(FileAddTagsParams fileAddTagsParams)
        : base(fileAddTagsParams)
    {
        this._rawBodyData = new(fileAddTagsParams._rawBodyData);
    }
...
#pragma warning restore CS8618
    ...
    public static FileAddTagsParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        IReadOnlyDictionary<string, JsonElement> rawBodyData
    )
    ...
    public virtual bool Equals(FileAddTagsParams? other)
    {
        if (other == null)
        {
            return false;
