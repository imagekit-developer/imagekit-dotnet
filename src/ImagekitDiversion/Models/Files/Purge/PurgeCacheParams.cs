...
/// </summary>
public record class PurgeCacheParams : ParamsBase
{
    ...
    public PurgeCacheParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public PurgeCacheParams(PurgeCacheParams purgeCacheParams)
        : base(purgeCacheParams)
    {
        this._rawBodyData = new(purgeCacheParams._rawBodyData);
    }
...
#pragma warning restore CS8618
    ...
    public static PurgeCacheParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        IReadOnlyDictionary<string, JsonElement> rawBodyData
    )
    ...
    public virtual bool Equals(PurgeCacheParams? other)
    {
        if (other == null)
        {
            return false;
