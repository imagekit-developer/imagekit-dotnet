...
/// </summary>
public record class FileRemoveTagsParams : ParamsBase
{
    ...
    public FileRemoveTagsParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public FileRemoveTagsParams(FileRemoveTagsParams fileRemoveTagsParams)
        : base(fileRemoveTagsParams)
    {
        this._rawBodyData = new(fileRemoveTagsParams._rawBodyData);
    }
...
#pragma warning restore CS8618
    ...
    public static FileRemoveTagsParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        IReadOnlyDictionary<string, JsonElement> rawBodyData
    )
    ...
    public virtual bool Equals(FileRemoveTagsParams? other)
    {
        if (other == null)
        {
            return false;
