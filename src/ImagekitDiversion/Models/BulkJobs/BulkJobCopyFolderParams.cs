...
/// </summary>
public record class BulkJobCopyFolderParams : ParamsBase
{
    ...
    public BulkJobCopyFolderParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public BulkJobCopyFolderParams(BulkJobCopyFolderParams bulkJobCopyFolderParams)
        : base(bulkJobCopyFolderParams)
    {
        this._rawBodyData = new(bulkJobCopyFolderParams._rawBodyData);
    }
...
#pragma warning restore CS8618
    ...
    public static BulkJobCopyFolderParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        IReadOnlyDictionary<string, JsonElement> rawBodyData
    )
    ...
    public virtual bool Equals(BulkJobCopyFolderParams? other)
    {
        if (other == null)
        {
            return false;
