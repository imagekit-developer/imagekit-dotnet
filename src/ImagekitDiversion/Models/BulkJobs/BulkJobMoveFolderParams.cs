...
/// </summary>
public record class BulkJobMoveFolderParams : ParamsBase
{
    ...
    public BulkJobMoveFolderParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public BulkJobMoveFolderParams(BulkJobMoveFolderParams bulkJobMoveFolderParams)
        : base(bulkJobMoveFolderParams)
    {
        this._rawBodyData = new(bulkJobMoveFolderParams._rawBodyData);
    }
...
#pragma warning restore CS8618
    ...
    public static BulkJobMoveFolderParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        IReadOnlyDictionary<string, JsonElement> rawBodyData
    )
    ...
    public virtual bool Equals(BulkJobMoveFolderParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    {
        return new UriBuilder(options.BaseUrl.ToString().TrimEnd('/') + "/v1/bulkJobs/moveFolder")
        {
