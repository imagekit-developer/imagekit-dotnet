...
/// </summary>
public record class BulkJobRenameFolderParams : ParamsBase
{
    ...
    public BulkJobRenameFolderParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public BulkJobRenameFolderParams(BulkJobRenameFolderParams bulkJobRenameFolderParams)
        : base(bulkJobRenameFolderParams)
    {
        this._rawBodyData = new(bulkJobRenameFolderParams._rawBodyData);
    }
...
#pragma warning restore CS8618
    ...
    public static BulkJobRenameFolderParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        IReadOnlyDictionary<string, JsonElement> rawBodyData
    )
    ...
    public virtual bool Equals(BulkJobRenameFolderParams? other)
    {
        if (other == null)
        {
            return false;
