...
public sealed record class SelectedFieldsSchemaItem : JsonModel
{
    ...
    /// </summary>
    public required ApiEnum<string, global::ImagekitDiversion.Models.Api.V1.Files.Type> Type
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNotNullClass<
                ApiEnum<string, global::ImagekitDiversion.Models.Api.V1.Files.Type>
            >("type");
        }
...
#pragma warning restore CS8618
    ...
    [SetsRequiredMembers]
    public SelectedFieldsSchemaItem(
        ApiEnum<string, global::ImagekitDiversion.Models.Api.V1.Files.Type> type
    )
        : this()
    {
        this.Type = type;
...
/// Type of the custom metadata field.
/// </summary>
[JsonConverter(typeof(global::ImagekitDiversion.Models.Api.V1.Files.TypeConverter))]
public enum Type
{
    Text,
    Textarea,
...
sealed class TypeConverter : JsonConverter<global::ImagekitDiversion.Models.Api.V1.Files.Type>
{
    public override global::ImagekitDiversion.Models.Api.V1.Files.Type Read(
        ref Utf8JsonReader reader,
        System::Type typeToConvert,
        JsonSerializerOptions options
    )
    {
        return JsonSerializer.Deserialize<string>(ref reader, options) switch
        {
            "Text" => global::ImagekitDiversion.Models.Api.V1.Files.Type.Text,
            "Textarea" => global::ImagekitDiversion.Models.Api.V1.Files.Type.Textarea,
            "Number" => global::ImagekitDiversion.Models.Api.V1.Files.Type.Number,
            "Date" => global::ImagekitDiversion.Models.Api.V1.Files.Type.Date,
            "Boolean" => global::ImagekitDiversion.Models.Api.V1.Files.Type.Boolean,
            "SingleSelect" => global::ImagekitDiversion.Models.Api.V1.Files.Type.SingleSelect,
            "MultiSelect" => global::ImagekitDiversion.Models.Api.V1.Files.Type.MultiSelect,
            _ => (global::ImagekitDiversion.Models.Api.V1.Files.Type)(-1),
        };
    }

    public override void Write(
        Utf8JsonWriter writer,
        global::ImagekitDiversion.Models.Api.V1.Files.Type value,
        JsonSerializerOptions options
    )
    {
        JsonSerializer.Serialize(
            ...
            value switch
            {
                global::ImagekitDiversion.Models.Api.V1.Files.Type.Text => "Text",
                global::ImagekitDiversion.Models.Api.V1.Files.Type.Textarea => "Textarea",
                global::ImagekitDiversion.Models.Api.V1.Files.Type.Number => "Number",
                global::ImagekitDiversion.Models.Api.V1.Files.Type.Date => "Date",
                global::ImagekitDiversion.Models.Api.V1.Files.Type.Boolean => "Boolean",
                global::ImagekitDiversion.Models.Api.V1.Files.Type.SingleSelect => "SingleSelect",
                global::ImagekitDiversion.Models.Api.V1.Files.Type.MultiSelect => "MultiSelect",
                _ => throw new ImagekitDiversionInvalidDataException(
                    string.Format("Invalid value '{0}' in {1}", value, nameof(value))
                ),
            },
