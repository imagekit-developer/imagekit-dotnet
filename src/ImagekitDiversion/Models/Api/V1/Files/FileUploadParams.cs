...
/// 25MB for images, audio, and raw files and 100MB for videos. On the Lite paid plan,
/// these limits increase to 40MB for images, audio, and raw files and 300MB for
/// videos, whereas on the Pro paid plan, these limits increase to 50MB for images,
...
public record class FileUploadParams : ParamsBase
{
    ...
    /// is only required for authentication when uploading a file from the client side.
    /// </summary>
    public long? Expire
    {
        get
    ...
    /// </summary>
    public TransformationObject? Transformation
    {
        get
        {
            this._rawBodyData.Freeze();
            return this._rawBodyData.GetNullableClass<TransformationObject>("transformation");
        }
        init
        {
            if (value == null)
