...
public record class Origin : ModelBase
{
    ...
    public Origin(S3 value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public Origin(S3Compatible value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public Origin(CloudinaryBackup value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public Origin(WebFolder value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public Origin(WebProxy value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public Origin(Gcs value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public Origin(AzureBlob value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public Origin(AkeneoPim value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public Origin(JsonElement element)
    {
        this._element = element;
    }
        ...
        switch (this.Value)
        {
            ...
            default:
                throw new ImagekitDiversionInvalidDataException(
                    "Data did not match any variant of Origin"
                );
        }
    }
    ...
    public static implicit operator Origin(S3 value) => new(value);

    public static implicit operator Origin(S3Compatible value) => new(value);

    public static implicit operator Origin(CloudinaryBackup value) => new(value);

    public static implicit operator Origin(WebFolder value) => new(value);

    public static implicit operator Origin(WebProxy value) => new(value);

    public static implicit operator Origin(Gcs value) => new(value);

    public static implicit operator Origin(AzureBlob value) => new(value);

    public static implicit operator Origin(AkeneoPim value) => new(value);
    ...
    public virtual bool Equals(Origin? other) =>
        other != null
