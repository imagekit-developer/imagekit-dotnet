...
public record class Imgix
{
    ...
    public void Validate()
    {
        if (this != new Imgix())
        {
            throw new ImagekitDiversionInvalidDataException("Invalid value given for 'Imgix'");
        }
    }
...
public record class Akamai
{
    ...
    public void Validate()
    {
        if (this != new Akamai())
        {
            throw new ImagekitDiversionInvalidDataException("Invalid value given for 'Akamai'");
        }
    }
