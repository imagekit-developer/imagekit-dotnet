...
public interface IOriginService
{
    ...
    /// `id`.
    /// </summary>
    Task<Origin> Retrieve(
        OriginRetrieveParams parameters,
        CancellationToken cancellationToken = default
    );

    /// <inheritdoc cref="Retrieve(OriginRetrieveParams, CancellationToken)"/>
    Task<Origin> Retrieve(
        string id,
...
public interface IOriginServiceWithRawResponse
{
    ...
    /// </summary>
    Task<HttpResponse<Origin>> Create(
        OriginCreateParams parameters,
        CancellationToken cancellationToken = default
    );
    ...
    /// same as <see cref="IOriginService.Retrieve(OriginRetrieveParams, CancellationToken)"/>.
    /// </summary>
    Task<HttpResponse<Origin>> Retrieve(
        OriginRetrieveParams parameters,
        CancellationToken cancellationToken = default
    );
    ...
    /// </summary>
    Task<HttpResponse<Origin>> Update(
        OriginUpdateParams parameters,
        CancellationToken cancellationToken = default
    );
    ...
    /// </summary>
    Task<HttpResponse<List<Origin>>> List(
        OriginListParams? parameters = null,
        CancellationToken cancellationToken = default
    );
