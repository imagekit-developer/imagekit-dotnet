...
namespace ImagekitDiversion.Services.Api.V1;
...
public interface IFileService
{
    ...
    /// technologies. </para>
    /// </summary>
    Task<Upload> Upload(FileUploadParams parameters, CancellationToken cancellationToken = default);
}
...
public interface IFileServiceWithRawResponse
{
    ...
    /// </summary>
    Task<HttpResponse<Upload>> Upload(
