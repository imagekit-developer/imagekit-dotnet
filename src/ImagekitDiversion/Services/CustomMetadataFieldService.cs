...
public sealed class CustomMetadataFieldService : ICustomMetadataFieldService
{
    ...
    public CustomMetadataFieldService(IImagekitDiversionClient client)
    {
        _client = client;
    ...
    : ICustomMetadataFieldServiceWithRawResponse
{
    ...
    public CustomMetadataFieldServiceWithRawResponse(IImagekitDiversionClientWithRawResponse client)
    {
        _client = client;
    }
