...
public class UrlEndpointRetrieveParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var parameters = new UrlEndpointRetrieveParams { ID = "id" };
    ...
    {
        UrlEndpointRetrieveParams parameters = new() { ID = "id" };
    ...
    public void CopyConstructor_Works()
    {
        ...
        UrlEndpointRetrieveParams copied = new(parameters);
