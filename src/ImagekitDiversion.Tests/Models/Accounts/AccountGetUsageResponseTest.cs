...
public class AccountGetUsageResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new AccountGetUsageResponse
        {
            BandwidthBytes = 0,
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<AccountGetUsageResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        AccountGetUsageResponse copied = new(model);
