...
public class OriginRetrieveParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var parameters = new OriginRetrieveParams { ID = "id" };
    ...
    {
        OriginRetrieveParams parameters = new() { ID = "id" };
    ...
    public void CopyConstructor_Works()
    {
        ...
        OriginRetrieveParams copied = new(parameters);
