...
namespace ImagekitDiversion.Tests.Models.Api.V2.Files;
...
public class FileUploadParamsTest : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        ...
        var parameters = new FileUploadParams
        {
            ...
            Transformation = new()
            {
                Post =
                [
                    new Files::Thumbnail() { Value = "w-150,h-150" },
                    new Files::Abs()
                    {
                        Protocol = Files::Protocol.Dash,
        ...
        Files::TransformationObject expectedTransformation = new()
        {
            Post =
            [
                new Files::Thumbnail() { Value = "w-150,h-150" },
    ...
    public void Url_Works()
    {
        ...
        Assert.True(
            TestBase.UrisEqual(new Uri("https://api.imagekit.io/api/v2/files/upload"), url)
        );
    }
