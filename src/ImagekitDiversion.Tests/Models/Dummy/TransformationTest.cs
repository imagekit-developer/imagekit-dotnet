...
public class TransformationTest : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        ...
        List<ApiEnum<string, TransformationStreamingResolution>> expectedStreamingResolutions =
        [
            TransformationStreamingResolution.V240,
        ];
...
public class TransformationStreamingResolutionTest : TestBase
{
    [Theory]
    [InlineData(TransformationStreamingResolution.V240)]
    [InlineData(TransformationStreamingResolution.V360)]
    [InlineData(TransformationStreamingResolution.V480)]
    [InlineData(TransformationStreamingResolution.V720)]
    [InlineData(TransformationStreamingResolution.V1080)]
    [InlineData(TransformationStreamingResolution.V1440)]
    [InlineData(TransformationStreamingResolution.V2160)]
    public void Validation_Works(TransformationStreamingResolution rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, TransformationStreamingResolution> value = rawValue;
        value.Validate();
    }
    ...
    public void InvalidEnumValidationThrows_Works()
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, TransformationStreamingResolution>>(
            JsonSerializer.SerializeToElement("invalid value"),
            ModelBase.SerializerOptions
        );
    ...
    [InlineData(TransformationStreamingResolution.V1440)]
    [InlineData(TransformationStreamingResolution.V2160)]
    public void SerializationRoundtrip_Works(TransformationStreamingResolution rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, TransformationStreamingResolution> value = rawValue;
        ...
        var deserialized = JsonSerializer.Deserialize<
            ApiEnum<string, TransformationStreamingResolution>
