...
public class ImageOverlayTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new ImageOverlay
        {
        ...
        ApiEnum<string, ImageOverlayImageOverlayEncoding> expectedEncoding =
            ImageOverlayImageOverlayEncoding.Auto;
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<ImageOverlay>(
            json,
    ...
    {
        var model = new ImageOverlay { Input = "input" };
...
public class ImageOverlayImageOverlayEncodingTest : TestBase
{
    [Theory]
    [InlineData(ImageOverlayImageOverlayEncoding.Auto)]
    [InlineData(ImageOverlayImageOverlayEncoding.Plain)]
    [InlineData(ImageOverlayImageOverlayEncoding.Base64)]
    public void Validation_Works(ImageOverlayImageOverlayEncoding rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, ImageOverlayImageOverlayEncoding> value = rawValue;
        value.Validate();
    }
    ...
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, ImageOverlayImageOverlayEncoding>>(
    ...
    [InlineData(ImageOverlayImageOverlayEncoding.Plain)]
    [InlineData(ImageOverlayImageOverlayEncoding.Base64)]
    public void SerializationRoundtrip_Works(ImageOverlayImageOverlayEncoding rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, ImageOverlayImageOverlayEncoding> value = rawValue;
        ...
        var deserialized = JsonSerializer.Deserialize<
            ApiEnum<string, ImageOverlayImageOverlayEncoding>
