...
public class SavedExtensionRetrieveParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var parameters = new SavedExtensionRetrieveParams { ID = "id" };
    ...
    {
        SavedExtensionRetrieveParams parameters = new() { ID = "id" };
    ...
    public void CopyConstructor_Works()
    {
        ...
        SavedExtensionRetrieveParams copied = new(parameters);
