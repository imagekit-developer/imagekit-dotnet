...
public class DetailUpdateParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var parameters = new DetailUpdateParams
        {
            FileID = "fileId",
        ...
        Body expectedBody = new UpdateFileDetails()
        {
            CustomCoordinates = "10,10,100,100",
            CustomMetadata = new Dictionary<string, JsonElement>()
            {
    ...
    {
        DetailUpdateParams parameters = new()
        {
            FileID = "fileId",
            Body = new UpdateFileDetails()
            {
    ...
    public void CopyConstructor_Works()
    {
        ...
        DetailUpdateParams copied = new(parameters);
...
{
    [Fact]
    public void UpdateFileDetailsValidationWorks()
    {
        Body value = new UpdateFileDetails()
        {
    ...
    {
        Body value = new ChangePublicationStatus()
        {
    ...
    [Fact]
    public void UpdateFileDetailsSerializationRoundtripWorks()
    {
        Body value = new UpdateFileDetails()
        {
            CustomCoordinates = "customCoordinates",
