...
public class FileRemoveAITagsParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var parameters = new FileRemoveAITagsParams
        {
    ...
    {
        FileRemoveAITagsParams parameters = new()
        {
            AITags = ["t-shirt", "round-neck", "sale2019"],
            FileIds = ["598821f949c0a938d57563bd", "598821f949c0a938d57563be"],
        };
    ...
    public void CopyConstructor_Works()
    {
        ...
        FileRemoveAITagsParams copied = new(parameters);
