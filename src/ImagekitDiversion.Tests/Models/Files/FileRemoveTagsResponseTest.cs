...
public class FileRemoveTagsResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new FileRemoveTagsResponse { SuccessfullyUpdatedFileIds = ["string"] };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<FileRemoveTagsResponse>(
            json,
    ...
    {
        var model = new FileRemoveTagsResponse { };
    ...
    public void CopyConstructor_Works()
    {
        ...
        FileRemoveTagsResponse copied = new(model);
