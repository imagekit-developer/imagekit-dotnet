...
public class BatchDeleteResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BatchDeleteResponse { SuccessfullyDeletedFileIds = ["string"] };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BatchDeleteResponse>(
            json,
    ...
    {
        var model = new BatchDeleteResponse { };
    ...
    public void CopyConstructor_Works()
    {
        ...
        BatchDeleteResponse copied = new(model);
