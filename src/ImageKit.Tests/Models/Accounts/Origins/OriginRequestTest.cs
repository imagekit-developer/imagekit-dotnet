...
public class OriginRequestTest : TestBase
{
    ...
    {
        OriginRequest value = new S3Compatible()
        {
            AccessKey = "AKIAIOSFODNN7EXAMPLE",
            Bucket = "product-images",
    ...
    {
        OriginRequest value = new CloudinaryBackup()
        {
            AccessKey = "AKIAIOSFODNN7EXAMPLE",
            Bucket = "product-images",
            Name = "US S3 Storage",
    ...
    {
        OriginRequest value = new WebFolder()
        {
    ...
    {
        OriginRequest value = new WebProxy()
        {
            Name = "US S3 Storage",
            BaseUrlForCanonicalHeader = "https://cdn.example.com",
            IncludeCanonicalHeader = false,
    ...
    {
        OriginRequest value = new AzureBlob()
        {
    ...
    {
        OriginRequest value = new AkeneoPim()
        {
...
public class WebProxyTest : TestBase
{
    ...
    public void OptionalNonNullablePropertiesUnsetAreNotSet_Works()
    {
        var model = new WebProxy { Name = "US S3 Storage" };
