...
public class BulkRemoveTagsResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BulkRemoveTagsResponse { SuccessfullyUpdatedFileIds = ["string"] };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BulkRemoveTagsResponse>(
            json,
    ...
    {
        var model = new BulkRemoveTagsResponse { };
    ...
    public void CopyConstructor_Works()
    {
        ...
        BulkRemoveTagsResponse copied = new(model);
