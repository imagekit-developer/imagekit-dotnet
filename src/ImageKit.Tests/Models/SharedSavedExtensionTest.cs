...
public class SharedSavedExtensionTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new SharedSavedExtension
        {
            ID = "ext_abc123",
            Config = new RemoveBg()
            {
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<SharedSavedExtension>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        SharedSavedExtension copied = new(model);
