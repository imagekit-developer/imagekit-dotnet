...
public class UploadPreTransformSuccessEventTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new UploadPreTransformSuccessEvent
        {
            ID = "id",
            Type = "type",
    ...
    public void CopyConstructor_Works()
    {
        ...
        UploadPreTransformSuccessEvent copied = new(model);
...
public class UnnamedSchemaWithArrayParent13Test : TestBase
{
    [Fact]
    public void StringValidationWorks()
    {
        UnnamedSchemaWithArrayParent13 value = "string";
        value.Validate();
    }
    ...
    public void DoubleValidationWorks()
    {
        UnnamedSchemaWithArrayParent13 value = 0;
        value.Validate();
    }
    ...
    public void BoolValidationWorks()
    {
        UnnamedSchemaWithArrayParent13 value = true;
        value.Validate();
    }
    ...
    public void StringSerializationRoundtripWorks()
    {
        UnnamedSchemaWithArrayParent13 value = "string";
        string element = JsonSerializer.Serialize(value, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<UnnamedSchemaWithArrayParent13>(
            element,
            ModelBase.SerializerOptions
        );
