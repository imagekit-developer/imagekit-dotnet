...
namespace ImagekitSample
{
    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            ImagekitClient imagekit = new ImagekitClient("public_qRpIDJNvD/8/u8GXcnvokaAa6qg=", "private_nJyfOxhvVWkHlq/1L2hPH4a1Zlo=", "https://ik.imagekit.io/your_imagekit_id/endpoint");
